...
const loginScreenAudio = {
  Mandinka_GMB: require("../../assets/audio/Mandinka_GMB/login-audio.mp3"),
  Wollof_GMB: require("../../assets/audio/Wollof_GMB/login-audio.mp3"),
};



export { splashScreenAudio, loginScreenAudio }; 